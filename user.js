 ...
 * [SETTING] Privacy & Security>Security>Deceptive Content and Software Protection ***/
user_pref("browser.safebrowsing.downloads.enabled", false); // intentional devication
...
user_pref("browser.safebrowsing.provider.google.updateURL", ""); // intentional devication
...
user_pref("layout.css.visited_links_enabled", true); // intentional devication
...
user_pref("browser.urlbar.suggest.history", false); // intentional devication
user_pref("browser.urlbar.suggest.bookmark", false); // intentional devication
user_pref("browser.urlbar.suggest.openpage", false); // intentional devication
...
user_pref("browser.urlbar.oneOffSearches", false); // intentional devication
...
user_pref("browser.display.use_document_fonts", 0); // intentional devication
...
user_pref("network.http.referer.XOriginPolicy", 0);  // 1 breaks E/// play
 ...
 * [SETTING] Privacy & Security>Content Blocking>Send websites a "Do Not Track"... ***/
   // user_pref("privacy.donottrackheader.enabled", false); // use default to blend in
...
user_pref("plugin.state.java", 0); // better keep
...
user_pref("layers.acceleration.disabled", true); // intended deviation
...
user_pref("media.media-capabilities.enabled", false); // intended deviation
...
user_pref("browser.download.folderList", 2); // intended deviation
...
user_pref("network.cookie.cookieBehavior", 0); // intended deviation
