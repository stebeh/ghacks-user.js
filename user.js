...
user_pref("browser.urlbar.suggest.history", false);  // stefan
user_pref("browser.urlbar.suggest.bookmark", false); // stefan
user_pref("browser.urlbar.suggest.openpage", false); // stefan
user_pref("browser.urlbar.suggest.topsites", false); // stefan
...
user_pref("pdfjs.disabled", true); // stefan
...
user_pref("network.cookie.lifetimePolicy", 2); // stefan: needed to delete dom.storage; dom.storage.next_gen may make this unnecessary when Mozilla makes it true by default; test: does quitting FF log you out of onvista.de?
...
user_pref("privacy.clearOnShutdown.siteSettings", true); // stefan: better clear all
...
user_pref("extensions.pocket.enabled", false); // stefan: disable Pocket Account [FF46+]
